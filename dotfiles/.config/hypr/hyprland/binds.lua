...
hl.bind("SUPER + T", hl.dsp.exec_cmd("kitty --title todo -e ~/git/cli-todolist/todolist_dev_main.sh"))
hl.bind("SUPER + G", hl.dsp.exec_cmd("kitty --title sfm -e ~/git/sfm/sfm.sh"))
-- SCREENSHOTS:
hl.bind("SUPER + X", hl.dsp.exec_cmd("grim -g $(slurp) ${HOME}/Screenshots/$(date '+%y%m%d_%H-%M-%S').png"))
hl.bind("SUPER + Z", hl.dsp.exec_cmd("grim -o $(hyprctl -j monitors | jq -r '.[] | select(.focused) | .name') ${HOME}/Screenshots/$(date '+%y%m%d_%H-%M-%S').png"))
